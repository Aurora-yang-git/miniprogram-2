...
export class Classifier {
    ...
    load() {
        return new Promise((resolve, reject) => {
            ...
            const modelPath = `${wx.env.USER_DATA_PATH}/${baseUrl}`;
    ...
    preProcess(frame, dstInput) {
        console.log(frame, dstInput, '99999')
        return new Promise((resolve, reject) => {
    ...
    async detect(frame) {
        ...
        return new Promise((resolve, reject) => {
            this.preProcess(frame, this.modelInput).then(() => {
                ...
                console.log(this.modelInput.buffer, 'this.modelInput.buffer')
                const xinput = {
                ...
                this.session.run({
                    ...
                    .then((res) => {
                        ...
                        let num = new Float32Array(res.probs.data)
                        console.log(num, num[0], num.length, 'num')
                        var maxVar = num[0];
    ...
    getClass(index) {
        ...
        console.log(this.mPredClass, 'this.mPredClass')
    }
